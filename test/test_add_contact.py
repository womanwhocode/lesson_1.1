...
def test_add_contact(app):
    ...
    contact = Contact(user_firstname="alena_3", user_middlename="z", user_lastname="y", user_nickname="alenaomg", photo_path="/Users/alyona_zaytseva/Downloads/IMG_5814.JPG", user_title="piter", company_name="nestle", address="tujx", home_phone="derlin", mobile_phone="7788",
