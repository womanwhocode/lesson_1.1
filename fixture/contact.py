...
class ContactHelper:
    ...
    def create(self, contact):
        ...
        wd.find_element_by_name("firstname").send_keys(contact.user_firstname)
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys(contact.user_middlename)
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys(contact.user_lastname)
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys(contact.user_nickname)
        ...
        wd.find_element_by_name("home").send_keys(contact.home_address)
